...
import com.letsdoit.app.ai.model.averageConfidence
import com.letsdoit.app.ai.process.AiMetricsRecorder
import com.letsdoit.app.ai.process.AiCallMetric
import com.letsdoit.app.ai.process.AiParseCache
import com.letsdoit.app.ai.process.AiPreprocessor
...
import com.letsdoit.app.ai.settings.AiSettingsRepository
...
class AiRouter @Inject constructor(
    ...
    suspend fun draftPlan(title: String, notes: String?): List<com.letsdoit.app.ai.model.PlannedStep> {
        val settings = settingsRepository.settings.first()
        val provider = textProviders[settings.textProvider] ?: error("Missing text provider")
    ...
    private fun decodePlan(body: String): List<com.letsdoit.app.ai.model.PlannedStep> {
        val type = Types.newParameterizedType(List::class.java, com.letsdoit.app.ai.model.PlannedStep::class.java)
        val adapter = moshi.adapter<List<com.letsdoit.app.ai.model.PlannedStep>>(type)
        return adapter.fromJson(body) ?: emptyList()
    }
