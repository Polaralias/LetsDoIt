...
import com.polaralias.letsdoit.ui.viewmodel.AiPreviewState
import com.polaralias.letsdoit.ui.viewmodel.TasksListEvent
import com.polaralias.letsdoit.ui.viewmodel.TasksListViewModel
import com.polaralias.letsdoit.data.model.Task
import com.polaralias.letsdoit.ui.util.debouncedItemPlacement
...
fun TasksListScreen(onOpenSettings: () -> Unit = {}, viewModel: TasksListViewModel = hiltViewModel()) {
    ...
    val openTask = remember { { task: com.polaralias.letsdoit.data.model.Task -> selectedTaskId.value = task.id } }
